...
/** Placeholder — full browse jobs screen coming next */
export default function LocumJobsScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Browse jobs</Text>
      <Text style={styles.sub}>Paginated job list will be built here.</Text>
    </View>
  );
}
